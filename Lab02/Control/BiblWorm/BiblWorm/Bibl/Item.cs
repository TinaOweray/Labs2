namespace MyClass
{
    abstract class Item : IComparable<Item>, IComparable
    {
        ...
        int IComparable.CompareTo(object? obj)
        {
            ...
            if (obj is not Item it)
                throw new ArgumentException("Object is not an Item", nameof(obj));

            return invNumber.CompareTo(it.invNumber);
